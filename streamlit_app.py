...
def main():
    ...
    webrtc_ctx = webrtc_streamer(key="object-detection",video_html_attrs=VideoHTMLAttributes(autoPlay=True, controls=False, style={"width": "100%"},video_transformer_factory=AgeDetector)
